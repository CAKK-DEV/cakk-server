...
class SignServiceTest extends ServiceTest {
	...
	void signUp1() {
		...
		doReturn(user.getProviderId()).when(oidcProviderFactory).getProviderId(param.getProvider(), param.getIdToken());
	...
	void signIn() {
		...
		doReturn(providerId).when(oidcProviderFactory).getProviderId(param.getProvider(), param.getIdToken());
